    ...
    <body>
        ...
        <main>
            ...
            <section id="section2">
                ...
                <form action="processing-RegistrationPageDoctor.php" method="POST">
                    ...
                    <input class="flexChild" type="text" name="DOB" placeholder="YYYY-MM-DD" required />
                    ...
                    <input class="flexChild" type="password" name="Pass" required />
                    </fieldset>
                    <fieldset class="flexbox" >
                    ...
                    <input  id="btn-submit" type="submit" value="Sign up" name="submit" required />
                </form>

            </section>
            <section id="section3">
                <h1 class="h-center morePaddingTop">Patient Sign Up</h1>
                <form action="processing-RegistrationPagePatient.php" method="POST">
                    <fieldset class="flexContainer">
                    <fieldset class="flexbox" >
                    <label for="Fname">First Name</label>
                    <input class="flexChild" type="text" name="Fname" required />
                    ...
                    <input  id="btn-submit2" type="submit" value="Sign up" name="submit" required />
                </form>
            </section>
            <footer>
            </footer>
